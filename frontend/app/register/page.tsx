...
export default function RegisterPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      saveAuth({ token: data.token, role: "USER", profile: data.user });
      refreshAuth();
            ...
            <form onSubmit={submit} className="space-y-5">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <SelectField
                  ...
                  onChange={(value) => update("addiction_type", value)}
                  options={[
              ...
              <div>
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  <LevelButton
                    ...
                    onClick={() => update("consumption_level", "faible")}
                  />
                  ...
                  <LevelButton
                    ...
                    onClick={() => update("consumption_level", "moyen")}
                  />
                  ...
                  <LevelButton
                    ...
                    onClick={() => update("consumption_level", "élevé")}
                  />
                </div>
              </div>
    ...
    <div>
      ...
      <div className="relative">
        ...
        <select
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className="h-14 w-full appearance-none rounded-2xl border border-slate-200 bg-slate-50 pl-12 pr-4 text-sm font-semibold text-slate-800 outline-none transition focus:border-[#1B4F59] focus:bg-white focus:ring-4 focus:ring-teal-100"
        >
          {options.map((option) => (
