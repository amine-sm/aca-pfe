...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 03 juin 2026 à 17:37
...
(11, 1, 1, 3, '0000-00-00 00:00:00', 45, 'in_person', 'confirmed', 'paid', 2500.00, 'DZD', 'Première séance après questionnaire', '2026-06-03 15:13:36');
...
(3, 1, '2026-06-03', '18:50:00', '19:50:00', 'in_person', 'pending', '2026-06-03 15:13:08');
...
CREATE TABLE `questionnaires` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `questionnaire_type` varchar(100) DEFAULT NULL,
  `answers` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`answers`)),
...
CREATE TABLE `users` (
  ...
  `consumption_level` varchar(50) DEFAULT NULL,
